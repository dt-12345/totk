if (DEFINED ENV{EXKING_CLANG})
    set(EXKING_CLANG "$ENV{EXKING_CLANG}")
else()
    set(EXKING_CLANG "${CMAKE_CURRENT_LIST_DIR}/clang-14.0.0")
endif()
...
set(CMAKE_C_COMPILER "${EXKING_CLANG}/bin/clang")
set(CMAKE_C_COMPILER_TARGET ${NX64_TRIPLE})
set(CMAKE_CXX_COMPILER "${EXKING_CLANG}/bin/clang++")
...
if (DEFINED EXKING_LINKER)
    message(STATUS "Using custom linker: ${EXKING_LINKER}")
    add_link_options(-fuse-ld=${EXKING_LINKER})
    if (DEFINED EXKING_LINKER_FLAGS)
        add_link_options(${EXKING_LINKER_FLAGS})
    endif()
else()
